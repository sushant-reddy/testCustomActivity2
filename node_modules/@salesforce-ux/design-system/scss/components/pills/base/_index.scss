...
.slds-pill {
  ...
  &:focus {
    ...
    --slds-c-pill-shadow: var(--sds-c-pill-shadow-focus, var(--_slds-g-shadow-outset-focus, #{$shadow-button-focus}));
...
.slds-pill__label {
  ...
  &:focus {
    ...
    box-shadow: var(--slds-c-pill-label-shadow-focus, var(--sds-c-pill-label-shadow-focus, var(--_slds-g-shadow-outset-focus, #{$shadow-button-focus})));
  }
}
...
.slds-pill__action {
  ...
  &:focus {
    box-shadow: var(--slds-c-pill-action-shadow, var(--sds-c-pill-action-shadow, var(--_slds-g-shadow-outset-focus, #{$shadow-button-focus})));
    outline: 0;
  }
}
