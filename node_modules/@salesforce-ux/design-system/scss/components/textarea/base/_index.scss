...
.slds-textarea {
  ...
  &:focus {
    ...
    box-shadow: var(--slds-c-textarea-shadow-focus, var(--_slds-g-shadow-outline-focus, #{$shadow-button-focus}));
  }
...
.slds-has-error .slds-textarea {
  ...
  &:focus {
    ...
    --slds-c-textarea-shadow-focus: var(--slds-g-color-error-base-40,
      #{$color-border-error}) 0 0 0 #{$border-width-thin} inset, var(--_slds-g-shadow-outline-focus, #{$shadow-button-focus});
  }
}
